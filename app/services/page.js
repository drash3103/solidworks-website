...
const servicesList = [
  ...
  },
  {
    ...
    description: [
      <><strong style={{ fontStyle: 'italic' }}><span style={{ color: '#6B21A8' }}>Bhavya</span> <span style={{ color: '#EA580C' }}>Future EduTech</span></strong> provides professional 3D design, CAD/CAM job work and design manpower supply services for mechanical and industrial projects. Our team delivers high-precision modeling, detailed drafting, and skilled design resources to support design projects with industry standards.</>,
