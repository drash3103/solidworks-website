...
const clients = [
  // Row 1
  "Xylem.png", "Ultimate Switchgear.jpg", "schurter-logo-approved.png", "UnipackTransLogo.png", "SDEC.png", "RSIS.jpg", "Idex.jpg",
  // Row 2
  ...
  // Row 4
  "TATA_Consultancy_Services.png", "L & T.png", "BAroda hi tech.jpg", "Orbit.jpg"
];
        ...
        <div className="container">
          ...
          <div className={styles.clientsGrid}>
            {clients.map((logo, index) => {
              const keyClients = [
                "TATA_Consultancy_Services.png",
                "L & T.png",
                "BAroda hi tech.jpg",
                "Orbit.jpg"
              ];
              const isLarge = keyClients.includes(logo);

              return (
                <div key={index} className={`${styles.clientLogoWrapper} ${isLarge ? styles.largeLogoWrapper : ''}`}>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
